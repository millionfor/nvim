...
function M.config()
  vim.api.nvim_create_user_command("GitlabSnippetCreate", function()
    require("pack/gitlab-snippet").upload_current_buffer_interactive({ mode = "create" })
  end, {})

  vim.api.nvim_create_user_command("GitlabSnippetUpdate", function()
    require("pack/gitlab-snippet").update_current_buffer_quick()
  end, {})

  vim.api.nvim_create_user_command("GitlabSnippetUpload", function()
    require("pack/gitlab-snippet").upload_current_buffer_interactive()
  end, {})

  G.map({
    { "n", "wc", ':lua require("pack/gitlab-snippet").upload_current_buffer_interactive({mode="create"})<cr>', { noremap = true, silent = true } },
    { "n", "wu", ':lua require("pack/gitlab-snippet").update_current_buffer_quick()<cr>', { noremap = true, silent = true } },
  })
end
