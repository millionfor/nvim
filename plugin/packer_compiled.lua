...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/copilot.vim",
  ...
  ["fzf.vim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/fzf.vim",
  ...
  ["nvim-tree.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/nvim-tree.lua",
  ...
  playground = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/playground",
  ...
  ["vim-dadbod"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-dadbod",
  ...
  ["vim-dadbod-ui"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-dadbod-ui",
  ...
  ["vim-expand-region"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-expand-region",
  ...
  ["vim-fcitx2en"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-fcitx2en",
  ...
  ["vim-showmarks"] = {
    loaded = true,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/start/vim-showmarks",
  ...
  ["vim-startuptime"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-startuptime",
  ...
  vimcdoc = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vimcdoc",
...
time([[Sourcing ftdetect script at: /Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-markdown-toc/ftdetect/markdown.vim]], true)
vim.cmd [[source /Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-markdown-toc/ftdetect/markdown.vim]]
time([[Sourcing ftdetect script at: /Users/gongzijian/.local/share/nvim/site/pack/packer/opt/vim-markdown-toc/ftdetect/markdown.vim]], false)
vim.cmd("augroup END")
