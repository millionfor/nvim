...
_G.packer_plugins = {
  ...
  ["wilder.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/gongzijian/.local/share/nvim/site/pack/packer/opt/wilder.nvim",
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-foldsign', 'vim-expand-region', 'vim-interestingwords', 'vim-visual-multi'}, { event = "CursorHold *" }, _G.packer_plugins)]]
