...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'vim-expand-region', 'vim-visual-multi', 'nvim-foldsign', 'vim-interestingwords'}, { event = "CursorHold *" }, _G.packer_plugins)]]
