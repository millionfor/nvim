...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'vim-interestingwords', 'vim-visual-multi', 'nvim-foldsign', 'vim-expand-region'}, { event = "CursorHold *" }, _G.packer_plugins)]]
